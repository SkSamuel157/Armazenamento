...
const tarefaLista = document.querySelector("#tarefas-lista")
...
const salvar = (text, done = 0, save = 1) => {
    ...
    // Cria um Div no HTML com a classe tarefa
    ...
    //Utilizando dados do LocalStorege
    if (done) {
        tarefa.classList.add("done")
    }
    if (save) {
        saveTarefasLocalStore({ text, done: 0 })
    }
